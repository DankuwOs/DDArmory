...
public class HPEquipJAARM : HPEquipMissileLauncher
{
	...
	{
		base.OnEquip();
		foreach (InternalWeaponBay internalWeaponBay in weaponManager.GetComponentsInChildren<InternalWeaponBay>(true))
		{
	...
	public override void OnStartFire()
	{
		...
		{
			((JAARMGuidance)ml.GetNextMissile().guidanceUnit).gpsPoint = weaponManager.gpsSystem.currentGroup.currentTarget;
			ml.FireMissile();
		}
